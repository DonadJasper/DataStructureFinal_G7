...
<body style='background-color:#569cd1'>
<form action='${requestUri}' method='get'>

<div class = 'box'style = 'position:absolute;margin-top:530px;margin-left:635px;'></div>
<div class='note'>
<img src="image/tongodgif.gif" style = 'position:absolute;width:50px;height:50px;margin-top:520px' >
</div> 
<div class='note1'>
<img src="image/tongodgif.gif" style = 'position:absolute;width:50px;height:50px;margin-top:520px' >
</div> 
...
<div>
<input type='text' name='searchNum' value='10' style='color:#569cd1;border-style:none;background-color:#569cd1'>
</div>
<div>
<input type='image' src="image/54481.png" 
style='position:absolute;width:37px;height:37px;left:50%;top:50%;margin-top:-55px;
margin-left:368px '/>
</div>
<div>
<a href ='http://localhost:8080/Final_Project/TestProject'><img src="image/tongod.png" style='position:absolute;width:270px;height:270px;left:50%;top:50%;margin-top:-380px;
margin-left:-150px '></a>
</div>

<embed src="https://www.myinstants.com/instant/andas-valiendo-verga-35611/embed/" autostart="true" hidden="true" loop="5" volume="100" width="107" height="100"></embed>
